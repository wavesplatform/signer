...
export type IssueArgs = CommonArgs & MakeOptional<IIssueTransactionFields, 'chainId' | 'script'>;
...
export type ReissueArgs = CommonArgs & MakeOptional<IReissueTransactionFields, 'chainId'>;
export type BurnArgs = CommonArgs & MakeOptional<IBurnTransactionFields, 'chainId'>;
export type LeaseArgs = CommonArgs & ILeaseTransactionFields;
export type CancelLeaseArgs = CommonArgs & MakeOptional<ICancelLeaseTransactionFields, 'chainId'>;
...
export type SetScriptArgs = CommonArgs & MakeOptional<ISetScriptTransactionFields, 'chainId'>;
...
export type InvokeArgs = CommonArgs &
    MakeOptional<IInvokeScriptTransactionFields, 'chainId' | 'payment' | 'call' | 'feeAssetId'>;
